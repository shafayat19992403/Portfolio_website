        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              I am mostly interested in Artificial Intelligence research,
              Federated Learning research and fullstack web development. I also
              love crafting clean, scalable web applications. My goal is to
              build solutions that offer both exceptional perfromacnce and a
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  ...
                  (2020-2025) <strong>CGPA:</strong> 3.76/4.00
                </li>
                <li>
                ...
                <li>
                  <strong>Secondary School Certificate</strong> - Mymensingh
                  Zilla School, Mymensingh (2015-2017)
                  <ul>
                    <li>
                      <strong>GPA:</strong> 5.00/5.00
                    </li>
